...
public class  VirtualKeyRepo{
		...
		public static void main(String[] args) throws IOException {
			...
			System.out.println("\t`````````````````````````````````");
			System.out.println(" Developed by\t: Saptarshi Mondal \n Company\t: ABC & Co. \n");
			...
			public static void listFiles() {
				...
				File directoryPath = new File("D:\\javafsd\\Demo");
			...
			public static void deleteFile(String fileToBeDeleted) {
				...
				File file = new File( ("D:\\\\javafsd\\\\Demo") + "\\" + fileToBeDeleted );
			...
			public static void searchFile(String fileToBeSearched) {
				...
				File file = new File( ("D:\\\\javafsd\\\\Demo")+"\\"+ fileToBeSearched);
			...
			public static void createFile (String fileToBeCreated) {
				File file = new File(("D:\\\\javafsd\\\\Demo")  + "\\" + fileToBeCreated );
